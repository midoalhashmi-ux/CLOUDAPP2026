...
class _MatchesScreenState extends State<MatchesScreen> {
  ...
  Widget _buildMatchesList(BuildContext context, List<MatchModel> allMatches) {
    // لم يعد التصفية بحاجة لاستبعاد دوريات هنا — المصدر (Cloud Function)
    // أصبح يستبعد الدول غير المهمة من الأساس (راجع ALLOWED_COUNTRIES في
    // index.js)، فكل ما يصل هنا مقبول أصلاً. الدوريات المترجمة أعلاه
    // (leaguePriority) تظهر أولاً، وأي دوري آخر ضمن الدول المسموحة يظهر
    // بعدها بترتيب وروده، بترجمة اسمه إن وُجدت وإلا كما ورد من المصدر.
